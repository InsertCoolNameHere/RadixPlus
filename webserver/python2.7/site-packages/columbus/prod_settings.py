...
WEBSERVICE_HOST = 'http://tongue.cs.colostate.edu:8080/galileo-web-service'
...
BASE_DIR = '/s/parsons/l/sys/www/radix/columbus-master/'
...
ALLOWED_HOSTS = ['radix.cs.colostate.edu']
