...
DATABASES = {
    'default': {
        ...
        'NAME': 'rootsdb',  # name of the database to use
        'USER': 'rootsdb',  # user name to use while connecting to the database
        'PASSWORD': 'go4rams&radix',  # password to use while connecting the database
        'HOST': 'faure',  # public IP of the database server
...
ALLOWED_HOSTS = ['www.radix.cs.colostate.edu']
...
ADMINS = [
    ('Max Roselius', 'mroseliu@rams.colostate.edu'),
]
